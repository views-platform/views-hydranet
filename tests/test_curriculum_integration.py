...
class TestCurriculumIntegration:
    ...
    def setup_bridge(self):
        config = {
            ...
            "identity_cols": ["t", "i"], "features": ["lr_sb", "lr_ns", "lr_os"],
            ...
            "loss_reg": "lr_b", "loss_class": "lr_b", "loss_reg_a": 16, "loss_reg_c": 0.05,
        ...
        handler = VolumeHandler(
            data=data, axes=("T", "H", "W", "C"), channel_map=["t", "i", "lr_sb", "lr_ns", "lr_os"],
            time_col="t", id_col="i", spatial_cols=["y", "x"],
            identity_cols=["t", "i"], feature_cols=["lr_sb", "lr_ns", "lr_os"]
        )
