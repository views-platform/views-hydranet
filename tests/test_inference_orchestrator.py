...
class TestStreamingOrchestrator:
    ...
    def test_streaming_pf_matches_batch_pf(self):
        """
        Parity test: streaming and batch paths must produce identical y_pred arrays
        for the same input. Guards against future divergence between the twin methods.
        """
