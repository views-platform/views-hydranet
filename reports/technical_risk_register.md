...
### C-303: prose asserts a guard the code does not implement — SEVENTEEN occurrences, one of which rendered a WRONG VERDICT
...
All three are the epic's own subject, in the epic's own PR: **correcting a claim in one place and
...
failure**, and they accumulate occurrences: **C-303** (17), **C-320** (4), **C-328** (5), **C-329**,
