...
| quantity | value |
|---|---:|
| observed mean CRPS differential | -0.0745789 |
| origin-block CI | [-0.0806395, -0.0687146] |
| **MDE (origin-block, half-width)** | **0.00596248** |
| iid-over-cells CI (for contrast only) | [-0.0863685, -0.063878] |
| iid half-width | 0.0112452 |
| **origin-block ÷ iid width** | **0.53×** |
