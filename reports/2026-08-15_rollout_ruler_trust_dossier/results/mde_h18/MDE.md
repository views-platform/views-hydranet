...
| quantity | value |
|---|---:|
| observed mean CRPS differential | -0.0588059 |
| origin-block CI | [-0.0674615, -0.0493745] |
| **MDE (origin-block, half-width)** | **0.00904349** |
| iid-over-cells CI (for contrast only) | [-0.0701058, -0.0474895] |
| iid half-width | 0.0113081 |
| **origin-block ÷ iid width** | **0.80×** |
