...
| quantity | value |
|---|---:|
| observed mean CRPS differential | -0.0590562 |
| origin-block CI | [-0.0681057, -0.0491837] |
| **MDE (origin-block, half-width)** | **0.00946098** |
| iid-over-cells CI (for contrast only) | [-0.0725563, -0.0465807] |
| iid half-width | 0.0129878 |
