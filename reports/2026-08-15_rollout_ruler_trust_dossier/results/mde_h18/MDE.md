...
Epic #263 / S4 (#268). Pair: `violet_visitor` − `climatology`, target `sb`, h = 18. 13 origins, N = 170,430 cell-months. 2000 bootstrap replicates, 90% CI, seed 0.

| quantity | value |
|---|---:|
| observed mean CRPS differential | -0.048661 |
| origin-block CI | [-0.0573357, -0.0396564] |
| **MDE (origin-block, half-width)** | **0.00883966** |
| iid-over-cells CI (for contrast only) | [-0.060841, -0.0367267] |
| iid half-width | 0.0120572 |
| **origin-block ÷ iid width** | **0.73×** |
