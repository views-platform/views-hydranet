...
| quantity | value |
|---|---:|
| observed mean CRPS differential | -0.0465338 |
| origin-block CI | [-0.0567943, -0.0351182] |
| **MDE (origin-block, half-width)** | **0.0108381** |
| iid-over-cells CI (for contrast only) | [-0.0582988, -0.0355913] |
| iid half-width | 0.0113538 |
| **origin-block ÷ iid width** | **0.95×** |
