...
def get_hp_config():
    """
    S1 — BASELINE + target_weights
    Delta: adds per-target regression loss weighting.
    sb_best gets 2x weight, ns_best and os_best get 1x.
    """
    ...
    hyperparameters = {
        ...
        # ── S1 DELTA: per-target regression loss weights ──
        'target_weights': {
            'lr_sb_best': 2.0,
            'lr_ns_best': 1.0,
            'lr_os_best': 1.0,
