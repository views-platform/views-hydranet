...
def get_hp_config():
    """
    S2 — BASELINE + hurdle_threshold
    Delta: enables hurdle masking (zeroes regression loss where y=0).
    This is the PRIMARY SUSPECT for instability — ~95% of grid cells are
    zero, so the model receives almost no regression gradient from quiet regions.
    """
