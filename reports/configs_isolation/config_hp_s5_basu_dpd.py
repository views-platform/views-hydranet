...
def get_hp_config():
    """
    S5 — BASELINE + loss_reg: basu_dpd
    Delta: replaces shrinkage loss with Basu DPD loss.
    No new features (no hurdle, no qs99, no target_weights).
    Tests whether basu_dpd is stable on this architecture in isolation.
    """
    ...
    hyperparameters = {
        ...
        # ============================================================
        # Loss Functions
        # ── S5 DELTA: basu_dpd replaces shrinkage ──
        # ============================================================
        'loss_reg': 'basu_dpd',
        'loss_reg_alpha': 0.5,
        'loss_reg_sigma': 1.0,
