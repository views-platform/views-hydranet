...
def get_hp_config():
    """
    S3 — BASELINE + qs99 tail regularizer
    Delta: adds QS99 quantile-score penalty for extreme predictions.
    Should stabilize predictions, not destabilize — but untested in isolation.
    """
    ...
    hyperparameters = {
        ...
        # ── S3 DELTA: QS99 tail regularizer ──
        'qs99_weight': 0.1,
        'qs99_tau': 0.99,
