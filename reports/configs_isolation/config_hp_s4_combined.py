...
def get_hp_config():
    """
    S4 — BASELINE + target_weights + hurdle + qs99
    Delta: all three new features combined.
    Only run this if S1, S2, and S3 all pass individually.
    Tests interaction effects between the three features.
    """
    ...
    hyperparameters = {
        ...
        # ── S4 DELTA: all three new features ──
        'target_weights': {
            'lr_sb_best': 2.0,
            'lr_ns_best': 1.0,
            'lr_os_best': 1.0,
