...
class VisualDiagnostics:
    ...
    def biopsy_dataframe(self, df: pd.DataFrame, stage_label: str, features: List[str] = []) -> None:
        ...
        try:
            ...
            # Plot
            self._plot_grid(vol_slice, features, global_months, stage_label, subdir=self.dirs["pipeline"])
    ...
    def biopsy_volume(self, vh: VolumeHandler, stage_label: str) -> None:
        ...
        try:
            ...
            target_subdir = self.dirs["reasoning"] if "predict" in stage_label.lower() else self.dirs["pipeline"]
    ...
    def biopsy_tensor(self, tensor: torch.Tensor, stage_label: str, channel_names: List[str]) -> None:
        ...
        try:
            ...
            self._plot_grid(data, channel_names, t_indices, stage_label, subdir=self.dirs["pipeline"])
    ...
    def _plot_grid_with_context(self, data_5d, feature_names, time_indices, global_maps, context_feat, offset, stage_label, subdir: str = None) -> None:
        """
    ...
    def _plot_grid(self, data_5d: np.ndarray, feature_names: List[str], time_indices: np.ndarray, stage_label: str, subdir: str = None) -> None:
        """
        Core Plotting Logic.
