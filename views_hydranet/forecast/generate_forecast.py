...
def generate_forecast(model_path: ModelPathManager, model, views_vol, config, device):
    """
    ...
    os.makedirs(model_path.data_generated, exist_ok=True)
    ...
    with open(os.path.join(model_path.data_generated, filename), 'wb') as file:
